 ...
 *
 *  @title   Example Dataset: Red wine quality
 */
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `WineStuff` object stored the UCI AutoMPG dataset in a matrix.
...
object WineStuff
{
	...
	val fnamer = Array("fixed acidity", "volatile acidity", "citric acid", "residual sugar", "chlorides", "free sulfur dioxide", "total sulfur dioxide", "density", "pH", "sulphates", "alcohol", "quality")

    val fname = Array("fixed acidity", "volatile acidity", "citric acid", "residual sugar", "chlorides", "free sulfur dioxide", "total sulfur dioxide", "density", "pH", "sulphates", "alcohol", "quality")
...
banner ("Wine relation")
    ...
    //val auto_tab = Relation.apply(BASE_DIR + "Red_Wine_Quality.csv", "Wine", 0,  null,  ",", null)
    //auto_tab.show ()

    banner ("Wine (x, y) dataset")
    val xyr = auto_tab.toMatriD (0 to 11)
    //println (s"x = $x")
    //println (s"y = $y")
